...
def show_navigation_dock():
    ...
    # Inject global background animations
    st.markdown("""
    <div class="particles-container">
        ...
        <div class="particle" style="left: 30%; width: 6px; height: 6px; animation-duration: 25s; animation-delay: -5s;"></div>
        <div class="particle" style="left: 70%; width: 3px; height: 3px; animation-duration: 20s; animation-delay: -10s;"></div>
        <div class="particle" style="left: 90%; width: 5px; height: 5px; animation-duration: 18s; animation-delay: -2s;"></div>
        <div class="particle" style="left: 50%; width: 4px; height: 4px; animation-duration: 30s; animation-delay: -15s;"></div>
    </div>
    <br>
    """, unsafe_allow_html=True)
